...
def generate_mission_story(
    ...
    *,
    ...
    prompt = (
        ...
        "'out' means the pilot was transferred OUT — they departed the squadron and left for 'to_squadron'. Narrate as a departure: posted away, reassigned, transferred out. "
        "'in' means the pilot was transferred IN — a new arrival who joined the squadron. Narrate as a new arrival joining the unit. "
        "Never invert the direction: an outgoing pilot must never be described as joining, and an incoming pilot must never be described as departing.\n"
        ...
        "If kill_cause is present, it is the authoritative description of HOW the aircraft or pilot was lost — "
        "it overrides any generic reading of the outcome field regardless of whether outcome is 'shot_down' or 'killed'. "
        "NEVER say 'shot down' or 'destroyed by enemy fire' unless kill_cause is specifically 'shot_down'. "
        "NEVER say 'killed in combat' or imply enemy action unless kill_cause confirms it: "
        "'shot_down' = destroyed by enemy aircraft gunfire; "
        "'collision_enemy' = mid-air collision with an enemy aircraft — describe it as a collision, not as being shot down; "
        "'collision_friendly' = mid-air collision with a friendly aircraft — describe as a tragic accident, do NOT frame as enemy action; "
        "'friendly_fire' = destroyed by friendly aircraft guns — an accident of war, not enemy action; "
        ...
        "'crashed' = aircraft lost with no enemy involvement — engine failure, pilot error, or unknown cause. "
        ...
        "the player pilot did NOT fly it. Write exactly 2 short paragraphs as a brief log/report entry. "
        ...
        "Paragraph 2: factual account of the mission. "
        "If unflown_mission.pilot_entries is present, you MUST name individual pilots by rank and name "
        "when reporting kills or casualties — identical rules to 'unflown_mission' scope: "
        "for each entry with air_kills > 0 or ground_kills > 0, name them and their score; "
        "for each entry with outcome KIA/MIA/WIA, name them and state their fate explicitly. "
        "Pilots with outcome 'survived' and no kills need not be mentioned individually. "
        "If pilot_entries is absent or empty, note only mission type/area/formation if known. "
        "Do not invent kills, outcomes, or enemy details not present in the data.\n"
