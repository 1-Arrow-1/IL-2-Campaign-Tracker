...
def generate_mission_story(
    ...
    *,
    ...
    prompt = (
        ...
        "- If pilot_bio is present, it is the personal background the player chose for this pilot at career creation — his origins, personality, and life before the war. Draw from it when something in this chapter connects naturally to the pilot's personal history (a place, a memory, a motivation). Do not repeat it verbatim and do not force it into every chapter — let it surface only when it genuinely enriches the narrative.\n"
